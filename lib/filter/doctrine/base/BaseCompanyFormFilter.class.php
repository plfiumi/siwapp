...
abstract class BaseCompanyFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'invoice_legal_terms'            => new sfWidgetFormFilterInput(),
      'estimate_legal_terms'           => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'invoice_legal_terms'            => new sfValidatorPass(array('required' => false)),
      'estimate_legal_terms'           => new sfValidatorPass(array('required' => false)),
  ...
  public function getFields()
  {
    return array(
      ...
      'invoice_legal_terms'            => 'Text',
      'estimate_legal_terms'           => 'Text',
