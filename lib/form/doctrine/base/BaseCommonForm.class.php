...
abstract class BaseCommonForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'customer_business_name'  => new sfWidgetFormInputText(),
      ...
      'customer_mobile'         => new sfWidgetFormInputText(),
      'customer_comments'       => new sfWidgetFormTextarea(),
      'customer_tax_condition'  => new sfWidgetFormInputText(),
      ...
      'supplier_business_name'  => new sfWidgetFormInputText(),
      ...
      'supplier_mobile'         => new sfWidgetFormInputText(),
      'supplier_comments'       => new sfWidgetFormTextarea(),
      'supplier_tax_condition'  => new sfWidgetFormInputText(),
      ...
      'buy_order_number'        => new sfWidgetFormInputText(),
      'delivery_note_number'    => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'customer_business_name'  => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      ...
      'customer_mobile'         => new sfValidatorString(array('max_length' => 20, 'required' => false)),
      'customer_comments'       => new sfValidatorString(array('required' => false)),
      'customer_tax_condition'  => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'supplier_business_name'  => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      ...
      'supplier_mobile'         => new sfValidatorString(array('max_length' => 20, 'required' => false)),
      'supplier_comments'       => new sfValidatorString(array('required' => false)),
      'supplier_tax_condition'  => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'buy_order_number'        => new sfValidatorString(array('max_length' => 10, 'required' => false)),
      'delivery_note_number'    => new sfValidatorString(array('max_length' => 10, 'required' => false)),
