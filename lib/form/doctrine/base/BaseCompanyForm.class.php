...
abstract class BaseCompanyForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'invoice_legal_terms'            => new sfWidgetFormTextarea(),
      'estimate_legal_terms'           => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'invoice_legal_terms'            => new sfValidatorString(array('required' => false)),
      'estimate_legal_terms'           => new sfValidatorString(array('required' => false)),
